const githubUrl = "https://github.com/tmcnulty387/LaundryStatus";
  ...
  return (
    ...
    >
      <path
        ...
        0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82a7.65 7.65 0 0 1 4 0c1.53-1.04
  ...
  return (
    <footer className="site-footer">
      <a
        ...
        target="_blank"
        rel="noreferrer"
        aria-label="View LaundryStatus on GitHub"
        title="View LaundryStatus on GitHub"
      >
        <GitHubIcon />
      </a>
    </footer>
